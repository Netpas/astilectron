...
module.exports = {
    ...
    eventNames: {
        ...
        windowCmdSetTitle: "window.cmd.settitle",
        windowCmdGetTitle: "window.cmd.gettitle",
        windowCmdHook: "window.cmd.hook",
        ...
        windowEventSetBounds: "window.event.setbounds",
        windowEventGetBounds: "window.event.getbounds",
        windowEventSetTitle: "window.event.settitle",
        windowEventGetTitle: "window.event.gettitle",
        ...
        windowEventSystemAwake: "window.event.system.awake",
        windowEventSystemShutdown: "window.event.system.shutdown"
    },
    targetIds: {
        app: 'app',
        dock: 'dock'
